...
exports.handler = async (event) => {
  ...
  if (!visitor_id || !case_id || !argument_key || !vote) return respond(400, { error: 'Missing fields' });
  ...
  try {
    ...
    return respond(200, { ok: true, argument_key, up_count, down_count, my_vote: vote });
  } catch (e) {
